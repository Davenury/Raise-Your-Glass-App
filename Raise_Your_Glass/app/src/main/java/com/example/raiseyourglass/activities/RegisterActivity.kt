        ...
        etRegisterPassword.addTextChangedListener(object: TextWatcher{
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if(Validator.isPasswordValid(currentPassword)){
                    ...
                    tvLengthOfPassword.setTextColor(ContextCompat.getColor(applicationContext, R.color.good))
                }
                else{
                    tvLengthOfPassword.text = resources.getString(R.string.six_characters_bad)
                    tvLengthOfPassword.setTextColor(ContextCompat.getColor(applicationContext, R.color.bad))
                }
            }
        })
        ...
        etRegisterEmail.addTextChangedListener(object : TextWatcher{
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                if(Validator.isEmailValid(currentEmail)){
                    ...
                    tvEmailHasDot.setTextColor(ContextCompat.getColor(applicationContext, R.color.good))
                }
                else{
                    tvEmailHasDot.text = resources.getString(R.string.dot_in_email_bad)
                    tvEmailHasDot.setTextColor(ContextCompat.getColor(applicationContext, R.color.bad))
                }
            }
        })
